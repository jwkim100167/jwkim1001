...
import { FRUIT_EMOJI, FRUIT_LABEL, FRUITS, getFruitCounts, checkBellCondition } from '../utils/halliGalliGameLogic';
import { halligalliFlipCard, halligalliRingBell, halligalliResolveBell, halligalliDiscardTopCards } from '../services/supabaseTyping';
...
export default function HalliGalliPlay({
  ...
  // bell_resolving: 결과 처리 (bell_winner 또는 host)
  useEffect(() => {
