...
const CATEGORIES = [
  {
    ...
    items: [
      { name: '김치찌개백반',   meal: 'both'   },
      { name: '된장찌개백반',   meal: 'both'   },
      { name: '제육볶음',       meal: 'both'   },
  ...
  },
  {
    ...
    items: [
      { name: '파스타',         meal: 'both'   },
      { name: '크림파스타',     meal: 'both'   },
      { name: '토마토파스타',   meal: 'both'   },
      { name: '오일파스타',     meal: 'lunch'  },
      { name: '로제파스타',     meal: 'both'   },
      { name: '봉골레',         meal: 'both'   },
      { name: '까르보나라',     meal: 'both'   },
      { name: '리조또',         meal: 'both'   },
      { name: '스테이크',       meal: 'dinner' },
      { name: '함박스테이크',   meal: 'both'   },
      { name: '안심/등심스테이크', meal: 'dinner' },
      { name: '라자냐',         meal: 'both'   },
      { name: '그라탕',         meal: 'both'   },
      { name: '필라프',         meal: 'lunch'  },
      { name: '오믈렛',         meal: 'lunch'  },
      { name: '콥샐러드',       meal: 'lunch'  },
      { name: '시저샐러드',     meal: 'lunch'  },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { name: '분짜',        meal: 'lunch'  },
      { name: '팟타이',      meal: 'both'   },
      { name: '똠얌꿍',      meal: 'dinner' },
      { name: '카오팟',      meal: 'lunch'  },
      { name: '나시고렝',    meal: 'lunch'  },
      { name: '미고렝',      meal: 'lunch'  },
      { name: '그린커리',    meal: 'both'   },
      { name: '인도카레+난', meal: 'both'   },
      { name: '탄두리치킨',  meal: 'dinner' },
      { name: '반미',        meal: 'lunch'  },
      { name: '사테',        meal: 'dinner' },
    ],
  },
  {
    ...
    items: [
      { name: '샌드위치',       meal: 'lunch' },
      { name: '파니니',         meal: 'lunch' },
      { name: '베이글샌드',     meal: 'lunch' },
      { name: '클럽샌드위치',   meal: 'lunch' },
      { name: '에그베네딕트',   meal: 'lunch' },
      { name: '프렌치토스트',   meal: 'lunch' },
      { name: '팬케이크',       meal: 'lunch' },
      { name: '와플',           meal: 'lunch' },
      { name: '아보카도토스트', meal: 'lunch' },
      { name: '포케볼',         meal: 'lunch' },
      { name: '김밥+컵라면',    meal: 'lunch' },
    ],
  },
  {
    ...
    items: [
      ...
      { name: '김치전',        meal: 'both'   },
      { name: '파전/해물파전', meal: 'both'   },
      { name: '치즈볼',        meal: 'dinner' },
      { name: '감바스',        meal: 'dinner' },
      { name: '나가사키짬뽕',  meal: 'both'   },
    ],
  },
];
