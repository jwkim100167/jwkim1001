...
const CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      { name: '파스타',         meal: 'dinner' },
      { name: '크림파스타',     meal: 'dinner' },
      { name: '토마토파스타',   meal: 'dinner' },
      { name: '오일파스타',     meal: 'dinner' },
      { name: '로제파스타',     meal: 'dinner' },
      { name: '봉골레',         meal: 'dinner' },
      { name: '까르보나라',     meal: 'dinner' },
      { name: '리조또',         meal: 'dinner' },
      { name: '스테이크',       meal: 'dinner' },
      { name: '함박스테이크',   meal: 'dinner' },
      { name: '안심/등심스테이크', meal: 'dinner' },
      { name: '라자냐',         meal: 'dinner' },
      { name: '그라탕',         meal: 'dinner' },
      { name: '필라프',         meal: 'dinner' },
      { name: '오믈렛',         meal: 'dinner' },
      { name: '콥샐러드',       meal: 'dinner' },
      { name: '시저샐러드',     meal: 'dinner' },
    ],
  },
  {
