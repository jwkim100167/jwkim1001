...
import { getActualRank, getPredictions, findMyPrediction, getNextSchedule } from '../../../services/prediction/supabaseKbo';
      ...
      <div className="kbo-container">
        ...
        <section className="section-card rules-card">
          ...
          <ul className="rules-list">
            ...
            <li style={{ marginTop: '8px', opacity: 0.7 }}>
              <b>동률 타이브레이커</b>:<br/>
              1위 순위 적중 → 1위 가을야구 진입<br/>
              → 2위 순위 적중 → 2위 진입 → …<br/>
              모두 동률이면 <b>제출/수정 시간이 이른 순</b>
            </li>
          </ul>
        </section>
